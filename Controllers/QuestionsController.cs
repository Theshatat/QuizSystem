...
namespace QuizSystem.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Text,ImageUrl,Order,QuizId")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Text,ImageUrl,Order,QuizId")] Question question)
        {
            if (id != question.Id)
            {
                return NotFound();
